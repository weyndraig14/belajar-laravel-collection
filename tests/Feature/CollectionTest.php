...
class CollectionTest extends TestCase
{
    ...
    {
        $collection = collect(["agung"]);
        $result = $collection->mapInto(Person::class);
        $this->assertEquals([new Person("agung")], $result->all());
    }
    ...
    public function testMapSpread()
    {
        ...
        $this->assertEquals([
            new Person("agung vior"),
            new Person("okto paqih"),
        ], $result->all());
    }
    ...
    public function testCombine()
    {
        ...
        $collection2 = collect(["agung", "Indonesia"]);
    ...
    {
        $collection = collect(["agung", "vior", "okto"]);

        $this->assertEquals("agung-vior-okto", $collection->join("-"));
        $this->assertEquals("agung-vior_okto", $collection->join("-", "_"));
        $this->assertEquals("agung, vior and okto", $collection->join(", ", " and "));
    }
